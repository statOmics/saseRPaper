...
saveRDS(object = time_hyperparameter_optimalisation,
        file = paste0(output_directory,"/Time_hyperparameter_optimalisation_Fraser_PCA_Kremer_disease.RDS"))
...
saveRDS(object = time_analysis, 
        file = paste0(output_directory,"/Time_analysis_Fraser_PCA_Kremer_disease.RDS"))

saveRDS(object = time_total,
        file = paste0(output_directory,"/Time_Fraser_PCA_Kremer_disease_total.RDS"))
