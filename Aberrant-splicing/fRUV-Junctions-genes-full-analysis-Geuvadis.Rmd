...
saveRDS(object = time_filtering, 
        file = paste0(output_directory,"/Time_fRUV_junctions_gene_filtering_Geuvadis.RDS"))
...
seFindEncDim <- findEncodingDimRUVSplicing(seAllJunctionCounts,
...
time_hyperparameter_optimalisation <- end_time_hyperparameter_optimalisation -
  start_time_hyperparameter_optimalisation


saveRDS(object = time_hyperparameter_optimalisation, 
        file = paste0(output_directory,"/Time_fRUV_junctions_gene_hyperparameter_optimalisation_Geuvadis.RDS"))

saveRDS(object = seFindEncDim, 
        file = paste0(output_directory,"/seOptimalHyperparameters_fRUV_junctions_gene_Geuvadis.RDS"))
```
...
saveRDS(object = time_analysis, 
        file = paste0(output_directory,"/Time_fRUV_junctions_gene_analysis_Geuvadis.RDS"))

saveRDS(object = total_time, 
        file = paste0(output_directory,"/Time_fRUV_junctions_gene_total_Geuvadis.RDS"))

saveRDS(object = seFit, 
        file = paste0(output_directory,"/seFit_fRUV_junctions_gene_Geuvadis.RDS"))
```
