...
saveRDS(object = time_hyperparameter_optimalisation, 
        file = paste0(output_directory,"/Time_bins_hyperparameter_optimalisation_Kremer_disease.RDS"))

saveRDS(object = seFindEncDim, 
        file = paste0(output_directory,"/seOptimalHyperparameters_bins_Kremer_disease.RDS"))
```
...
saveRDS(object = time_analysis, 
        file = paste0(output_directory,"/Time_bins_Kremer_disease_analysis.RDS"))

saveRDS(object = total_time, 
        file = paste0(output_directory,"/Time_bins_Kremer_disease_total.RDS"))

saveRDS(object = seFit, 
        file = paste0(output_directory,"/seFit_bins_Kremer_disease_outliers.RDS"))
```
