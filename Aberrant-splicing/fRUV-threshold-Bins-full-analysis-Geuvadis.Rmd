...
saveRDS(object = time_filtering, 
        file = paste0(output_directory,"/Time_fRUV_threshold_bins_filtering_Geuvadis.RDS"))
...
saveRDS(object = time_analysis, 
        file = paste0(output_directory,
                      "/Time_fRUV_threshold_bins_analysis_Geuvadis.RDS"))

saveRDS(object = total_time, 
        file = paste0(output_directory,
                      "/Time_fRUV_threshold_bins_total_Geuvadis.RDS"))

saveRDS(object = seFit, 
        file = paste0(output_directory,"/seFit_fRUV_threshold_bins_Geuvadis.RDS"))
