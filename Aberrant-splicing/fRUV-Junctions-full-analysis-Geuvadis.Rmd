...
saveRDS(object = time_filtering, 
        file = paste0(output_directory,"/Time_fRUV_junctions_filtering_Geuvadis.RDS"))
...
saveRDS(object = time_hyperparameter_optimalisation, 
        file = paste0(output_directory,"/Time_fRUV_junctions_hyperparameter_optimalisation_Geuvadis.RDS"))

saveRDS(object = seFindEncDim, 
        file = paste0(output_directory,"/seOptimalHyperparameters_fRUV_junctions_Geuvadis.RDS"))
```
...
saveRDS(object = time_analysis, 
        file = paste0(output_directory,"/Time_fRUV_junctions_analysis_Geuvadis.RDS"))

saveRDS(object = total_time, 
        file = paste0(output_directory,"/Time_fRUV_junctions_total_Geuvadis.RDS"))

saveRDS(object = seFit, 
        file = paste0(output_directory,"/seFit_fRUV_junctions_Geuvadis.RDS"))
```
