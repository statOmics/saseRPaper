...
```{r}
fRUV_expression <- readRDS(file = paste0(data_directory_1, "/RUV_Analysis_Case_study.RDS"))
...
fRUV_junctions_gene <- readRDS(file = paste0(data_directory_2, "/seFit_bins_Kremer_disease_outliers.RDS"))
fRUV_jaccard <- readRDS(file = paste0(data_directory_2, "/seFit_fRUV_jaccard_Kremer_disease.RDS"))
